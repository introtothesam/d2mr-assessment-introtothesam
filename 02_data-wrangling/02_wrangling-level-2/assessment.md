...
2.  Did you use LLMs or other AI models to generate text or code for this project? If so, which tools did you use and how did you use them? Remember in this class you *are* allowed (even encouraged) to use these tools for help with coding, but not for writing text. This can be very brief, just one or two sentences is fine unless you have more you'd like to add.
    1.  I asked AI model to explain the functions in packages such as \`ggiraph\` and explain the error message
...
3.  Integrate a GitHub repo with an R studio project, including .gitignore file
    ...
    2.  .gitignore comprehensively excludes unnecessary, private, and very large files and is be commeted appropriately
        ...
        -   [ ] Unique objective attempt
        -   [ ] Objective met
        -   Grader comments: It doesn't seem to me that the .gitignore file is included in the project. Please let me know if you have any questions about this.
...
26. Create and maintain a quarto document YAML header
    ...
    1.  Includes all necessary metadata, output options, and formatting options necessary to render an APA styled document (or other specified style if appropriate for the project)
        ...
        -   [x] Unique objective attempt
        -   [ ] Objective met
        -   Grader comments: You do have a YAML header, but not for an APA styled document. Please let me know if you have any questions about this.
...
27. Use quarto R Markdown to compose an academic manuscript
    ...
    4.  Includes at least 1 footnote
        ...
        -   [ ] Unique objective attempt
        -   [x] Objective met
        -   Grader comments: Missed the footnote though.
...
1.  Use frequent, informative comments in code and markdown
    -   I provided detailed comments in both my R scripts and Quarto document, explaining each step of my data wrangling, visualization, and hypothesis testing processes.
2.  Find and understand documentation for R packages and functions
    -   I referenced function documentation to ensure correct implementation of ggplot2, dplyr, broom, and other packages (ggiraph), using function_name and source when needed.
3.  Follow a debugging workflow with independent and collaborative strategies
    -   I debugged issues by isolating problematic code in separate scripts, using print statements, and checking error messages systematically. (demenstated in final touch of data wrangling label: debugging-all-equal-differences)
4.  Parse and investigate error messages
    -   I successfully resolved errors by analyzing messages in the R console line by line. (demenstated in final touch of data wrangling label: debugging-all-equal-differences)
5.  Follow a coding style guide
    -   I use tidyverse styling conventions, ensuring proper indentation, consistent naming, and the use of pipes (%\>%) for readability.
6.  Create and use intermediate datasets
    -   I created intermediate datasets in data analysis section, verifying transformations before applying final analyses.
7.  Determine when code is better suited for a sourced script vs. a notebook chunk and source scripts appropriately
    -   I structured my plotting funtion in script (.R script) from final report(Quarto notebook), sourcing scripts when I create interactive maps.
8.  Explain and apply the “grammar of graphics”
    -   I structured my visualizations using ggplot2, mapping aesthetics clearly and layering components logically.
9.  Name and differentiate R data types
    -   I handled different data types (character, factor, numeric, etc.), converting between them as needed for wrangling, analysis, and visualization.
10. Name and differentiate R objects
    -   I effectively used data.frame, tibble, list, and vector objects, selecting appropriate structures based on my needs.
11. Define “tidy” data and explain its advantages and disadvantages
    -   I structured my dataset in a tidy format, ensuring variables were in columns and observations in rows, facilitating easy analysis with tidyverse functions.
12. Recognize and interpret common data visualizations
    -   I created and interpreted scatter plots, bar plot, choropleth mapand box plots, selecting appropriate visualizations for each research question.
13. Determine most appropriate visualizations and analyses for specific research questions and data
    -   I carefully chose visualizations based on the nature of my variables, using faceting and grouping to enhance clarity and interpretability.
...
**Off-the-Syllabus Skills Demonstrated: Interactive Map Using `ggiraph`**

For this project, I independently explored `ggiraph`, an advanced interactive visualization package for `ggplot2`. Instead of creating a static map, I leveraged `ggiraph`'s interactive features to allow users to dynamically explore economic and geographic data through hover tooltips, clickable regions, and responsive highlighting.

I independently explored advanced visualization techniques, developing three distinct types of interactive plots to enhance data exploration. These include a **ggiraph-enhanced interactive map, a facet-based comparative visualization, and a dynamic scatter plot** with economic indicators.

By incorporating `geom_sf_interactive()`, I enabled users to hover over different countries and immediately see key statistics like economic scores, population, and life expectancy in dynamically displayed tooltips. The **hover effect changes country colors** for immediate feedback, and clickable regions provide deeper exploration.

Additionally, I implemented **click interactions**, which allow users to filter and focus on specific regions, providing a more engaging and exploratory experience compared to traditional static maps. I customized the **tooltip appearance** and hover effects, ensuring a clean and readable interface.

I explored its documentation, tested different settings, and refined the plot structure to balance usability and aesthetic quality. The skills gained through this process, including handling geographic data, customizing interactivity, and refining user engagement, highlight my ability to go beyond course materials and apply innovative data visualization techniques to enhance data-driven storytelling.
...
This project was a comprehensive exploration of **data wrangling, visualization, and statistical analysis**, pushing me beyond the core syllabus and into more advanced techniques. It required me to clean, transform, and analyze complex datasets, ensuring they were structured for meaningful visualizations and hypothesis testing. The process of integrating interactivity into visualizations was particularly rewarding, as it allowed me to enhance the user experience and storytelling aspects of data analysis.

One of the most valuable aspects of this project was mastering efficient data wrangling techniques. I worked with both numeric and categorical data, handling missing values, recoding variables, and restructuring datasets for different analyses. This process reinforced my ability to use dplyr functions effectively, ensuring that my transformations were both efficient and reproducible.

I also learned how to build publication-quality tables and figures, refining my approach to creating clear, readable, and well-formatted outputs using `flextable` and `ggplot2`. Additionally, using `ggiraph` for interactivity opened up new possibilities for engaging and exploratory data storytelling, which I had not previously explored in depth.

One of the biggest challenges was ensuring that the dataset was fully structured for different types of analysis. Some variables needed recoding, aggregation, or transformation, and making sure that the dataset was in the right format for both statistical testing and visualization required careful planning. I encountered issues where some variables were not properly recognized as numeric, leading to errors in summary statistics, which forced me to improve my debugging workflow and use structured data validation techniques. The interactive visualizations also posed challenges, particularly in optimizing rendering performance. Debugging interactivity settings and ensuring that plots remained intuitive took considerable effort.

If I were to repeat this project, I would experiment with additional visualization frameworks, such as `plotly` or `Shiny`, to further enhance interactivity. While `ggiraph` provided an excellent entry into interactive ggplot extensions, integrating dashboard elements or dynamic filtering would take the exploratory aspect of the visualizations even further.

The most satisfying part of the project was seeing how data wrangling, visualization, and analysis came together to tell a meaningful story. Building an interactive combined map, structuring facet-based comparisons, and conducting statistical tests gave me a well-rounded experience in data analysis.Ultimately, it has given me greater confidence in handling complex datasets, presenting findings clearly, and pushing beyond standard visualization techniques to create more engaging and informative analyses.
